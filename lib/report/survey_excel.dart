...
class SurveyExcel {
  static Future<File> createExcel() async {
    ...
    sheet.getRangeByName('B4').setText('Rapport Survey Site');
    ...
    sheet.getRangeByName('B9').setText('Amine Mejri');
  ...
  static Future<File> saveExcel(
      {required String name, required Workbook excel}) async {
    final byte = excel.saveAsStream();
    final dir = await getpath();
